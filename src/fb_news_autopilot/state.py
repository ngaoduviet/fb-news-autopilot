...
ALLOWED = {
    ...
    State.PUBLISHING: {State.PUBLISHED, State.PUBLISHED_COMMENT_PENDING, State.FAILED},
    ...
    State.REVIEW: set(), State.REJECTED: set(), State.HOLD_IMAGE_RIGHTS: set(),
    State.COMPLIANCE_HOLD: set(), State.VERIFIED_ON_FACEBOOK: set(), State.FAILED: set(),
}
